...
namespace MoonSharp.Interpreter
{
  ...
  public class ScriptRuntimeException : InterpreterException
  {
    ...
    public ScriptRuntimeException(ScriptRuntimeException ex)
      : base((Exception) ex, ex.DecoratedMessage)
    {
    ...
    public static ScriptRuntimeException ArithmeticOnNonNumber(DynValue l, DynValue r = null)
    {
      if (l.Type != DataType.Number && l.Type != DataType.String)
        return new ScriptRuntimeException("attempt to perform arithmetic on a {0} value", new object[1]
        {
          (object) l.Type.ToLuaTypeString()
        });
      if (r != null && r.Type != DataType.Number && r.Type != DataType.String)
        return new ScriptRuntimeException("attempt to perform arithmetic on a {0} value", new object[1]
        {
          (object) r.Type.ToLuaTypeString()
        });
    ...
    {
      if (l.Type != DataType.Number && l.Type != DataType.String)
        return new ScriptRuntimeException("attempt to concatenate a {0} value", new object[1]
        {
          (object) l.Type.ToLuaTypeString()
        });
      return r != null && r.Type != DataType.Number && r.Type != DataType.String ? new ScriptRuntimeException("attempt to concatenate a {0} value", new object[1]
      {
        (object) r.Type.ToLuaTypeString()
    ...
    /// <returns>The exception to be raised.</returns>
    public static ScriptRuntimeException LenOnInvalidType(DynValue r) => new ScriptRuntimeException("attempt to get length of a {0} value", new object[1]
    {
      (object) r.Type.ToLuaTypeString()
    });
    ...
    /// <param name="r">The right operand.</param>
    /// <returns>The exception to be raised.</returns>
    public static ScriptRuntimeException CompareInvalidType(DynValue l, DynValue r) => l.Type.ToLuaTypeString() == r.Type.ToLuaTypeString() ? new ScriptRuntimeException("attempt to compare two {0} values", new object[1]
    {
      (object) l.Type.ToLuaTypeString()
    }) : new ScriptRuntimeException("attempt to compare {0} with {1}", new object[2]
    {
      (object) l.Type.ToLuaTypeString(),
      (object) r.Type.ToLuaTypeString()
    });
    ...
    /// <returns>The exception to be raised.</returns>
    public static ScriptRuntimeException BadArgument(int argNum, string funcName, string message) => new ScriptRuntimeException("bad argument #{0} to '{1}' ({2})", new object[3]
    {
      (object) (argNum + 1),
      (object) funcName,
      (object) message
    ...
    public static ScriptRuntimeException BadArgumentUserData(
      ...
      bool allowNil)
    {
      return new ScriptRuntimeException("bad argument #{0} to '{1}' (userdata<{2}>{3} expected, got {4})", new object[5]
      {
        (object) (argNum + 1),
        (object) funcName,
        (object) expected.Name,
        allowNil ? (object) "nil or " : (object) "",
        got != null ? (object) ("userdata<" + got.GetType().Name + ">") : (object) "null"
      });
    }
    ...
    public static ScriptRuntimeException BadArgument(
      ...
      bool allowNil)
    {
      return new ScriptRuntimeException("bad argument #{0} to '{1}' ({2}{3} expected, got {4})", new object[5]
      {
        (object) (argNum + 1),
        (object) funcName,
        allowNil ? (object) "nil or " : (object) "",
    ...
    public static ScriptRuntimeException BadArgumentNoValue(
      ...
      DataType expected)
    {
      return new ScriptRuntimeException("bad argument #{0} to '{1}' ({2} expected, got no value)", new object[3]
      {
        (object) (argNum + 1),
        (object) funcName,
        (object) expected.ToErrorTypeString()
      });
    }
    ...
    /// <param name="funcName">Name of the function generating this error.</param>
    /// <returns>The exception to be raised.</returns>
    public static ScriptRuntimeException BadArgumentIndexOutOfRange(string funcName, int argNum) => new ScriptRuntimeException("bad argument #{0} to '{1}' (index out of range)", new object[2]
    {
      (object) (argNum + 1),
      (object) funcName
    });
    ...
    /// <param name="funcName">Name of the function generating this error.</param>
    /// <returns>The exception to be raised.</returns>
    public static ScriptRuntimeException BadArgumentNoNegativeNumbers(int argNum, string funcName) => new ScriptRuntimeException("bad argument #{0} to '{1}' (not a non-negative number in proper range)", new object[2]
    {
      (object) (argNum + 1),
      (object) funcName
    });
    ...
    /// <param name="funcName">Name of the function generating this error.</param>
    /// <returns>The exception to be raised.</returns>
    public static ScriptRuntimeException BadArgumentValueExpected(int argNum, string funcName) => new ScriptRuntimeException("bad argument #{0} to '{1}' (value expected)", new object[2]
    {
      (object) (argNum + 1),
      (object) funcName
    });
    ...
    /// <returns>The exception to be raised.</returns>
    public static ScriptRuntimeException IndexType(DynValue obj) => new ScriptRuntimeException("attempt to index a {0} value", new object[1]
    {
      (object) obj.Type.ToLuaTypeString()
    });
    ...
    /// </summary>
    /// <returns>The exception to be raised.</returns>
    public static ScriptRuntimeException LoopInIndex() => new ScriptRuntimeException("loop in gettable");
    ...
    /// </summary>
    /// <returns>The exception to be raised.</returns>
    public static ScriptRuntimeException LoopInNewIndex() => new ScriptRuntimeException("loop in settable");
    ...
    /// </summary>
    /// <returns>The exception to be raised.</returns>
    public static ScriptRuntimeException LoopInCall() => new ScriptRuntimeException("loop in call");
    ...
    /// </summary>
    /// <returns>The exception to be raised.</returns>
    public static ScriptRuntimeException TableIndexIsNil() => new ScriptRuntimeException("table index is nil");
    ...
    /// </summary>
    /// <returns>The exception to be raised.</returns>
    public static ScriptRuntimeException TableIndexIsNaN() => new ScriptRuntimeException("table index is NaN");
    ...
    /// <returns>The exception to be raised.</returns>
    public static ScriptRuntimeException ConvertObjectFailed(object obj) => new ScriptRuntimeException("cannot convert clr type {0}", new object[1]
    {
      (object) obj.GetType()
    });
    ...
    /// <returns>The exception to be raised.</returns>
    public static ScriptRuntimeException ConvertObjectFailed(DataType t) => new ScriptRuntimeException("cannot convert a {0} to a clr type", new object[1]
    {
      (object) t.ToString().ToLowerInvariant()
    });
    ...
    /// <returns>The exception to be raised.</returns>
    public static ScriptRuntimeException ConvertObjectFailed(DataType t, Type t2) => new ScriptRuntimeException("cannot convert a {0} to a clr type {1}", new object[2]
    {
      (object) t.ToString().ToLowerInvariant(),
      (object) t2.FullName
    });
    ...
    /// <returns>The exception to be raised.</returns>
    public static ScriptRuntimeException UserDataArgumentTypeMismatch(DataType t, Type clrType) => new ScriptRuntimeException("cannot find a conversion from a MoonSharp {0} to a clr {1}", new object[2]
    {
      (object) t.ToString().ToLowerInvariant(),
      (object) clrType.FullName
    });
    ...
    /// <returns>The exception to be raised.</returns>
    public static ScriptRuntimeException UserDataMissingField(string typename, string fieldname) => new ScriptRuntimeException("cannot access field {0} of userdata<{1}>", new object[2]
    {
      (object) fieldname,
      (object) typename
    });
    ...
    /// <returns>The exception to be raised.</returns>
    public static ScriptRuntimeException CannotResumeNotSuspended(CoroutineState state) => state == CoroutineState.Dead ? new ScriptRuntimeException("cannot resume dead coroutine") : new ScriptRuntimeException("cannot resume non-suspended coroutine");
    ...
    /// </summary>
    /// <returns>The exception to be raised.</returns>
    public static ScriptRuntimeException CannotYield() => new ScriptRuntimeException("attempt to yield across a CLR-call boundary");
    ...
    /// </summary>
    /// <returns>The exception to be raised.</returns>
    public static ScriptRuntimeException CannotYieldMain() => new ScriptRuntimeException("attempt to yield from outside a coroutine");
    ...
    {
      string errorTypeString = type.ToErrorTypeString();
      return debugText != null ? new ScriptRuntimeException("attempt to call a {0} value near '{1}'", new object[2]
      {
        (object) errorTypeString,
        (object) debugText
      }) : new ScriptRuntimeException("attempt to call a {0} value", new object[1]
      {
        (object) errorTypeString
      });
    }
    ...
    public static ScriptRuntimeException AccessInstanceMemberOnStatics(IMemberDescriptor desc) => new ScriptRuntimeException("attempt to access instance member {0} from a static userdata", new object[1]
    {
      (object) desc.Name
    });
    ...
    {
      return new ScriptRuntimeException("attempt to access instance member {0}.{1} from a static userdata", new object[2]
      {
        (object) typeDescr.Name,
        (object) desc.Name
      });
    }
